    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700 '>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-xl font-semibold'>Document Review</h1>
        </div>
        ...
        <p className='text-sm text-gray-500 font-light mt-1'>Supports PDF Document only</p>
      ...
      {/* right col */}
          <div className='w-full max-w-lg p-4 bg-white roun-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
...

            {
              ...
              <div className='flex-1 flex items-center justify-center'>
                <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                  ...
                  <p>upload your document and click "Review Document" to get started</p>
                </div>
              </div>
              ):(
