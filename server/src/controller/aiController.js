...
export const removeImageObject = async (req, res) => {
    try {
        ...
        await Creations.create({ user_id: userId, prompt:`Remove ${object} from image`, content:image_url, type: 'image' });
...
export const resumeReview = async (req, res) => {
    try {
        ...
        await Creations.create({ user_id: userId, prompt:`Review the uploaded resume`, content:content, type: 'resume-review' });
